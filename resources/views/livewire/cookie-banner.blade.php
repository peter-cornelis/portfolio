<div id="banner" class="fixed left-0 bottom-0 z-200 w-full py-4 px-8 bg-mainLight dark:bg-grey border-t-3 border-t-purple">
    <section class="grid grid-cols-[1fr_auto] max-w-4xl mx-auto">
            ...
            <div class="self-center text-6xl opacity-90">🍪</div>
        <button
