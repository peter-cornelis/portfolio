@props(['href', 'active' => false, 'color' => 'bg-green'])
...
<li 
    ...
    >
    <span 
        class="absolute w-96 h-32 rounded-full bg-white/20 -translate-x-1/2 -translate-y-1/2 scale-0 group-hover:scale-100 transition-transform duration-800 pointer-events-none"
