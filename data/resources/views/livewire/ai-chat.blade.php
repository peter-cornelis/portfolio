...
>
    ...
    <section 
        class="fixed dark:text-mainLight bottom-24 right-0 sm:max-w-md bg-lightGrey dark:bg-grey w-full p-4 sm:rounded-l-xl shadow-lg/30 border-t border-t-white/10 transition duration-300"
        x-show="showChat"
